    ...
    <div class="container">
        ...
        <div class="ads-form-steps">
            <div class="ads-form-steps__step  ads-form-steps__step--js" id="step1">
                <div class="ads-form-steps__title">
            ...
            <div class="ads-form-steps__step  ads-form-steps__step--js" id="step2">
                ...
                <div class="ads-form-steps__main-list  row">
                    <div class="ads-form-steps__col  ads-form-steps__col--content  content-text  col">
                        <h3>Модель</h3>
                        <input type="text" placeholder="Впишите сюда модель" class="input ads-form-step__input">
                    </div>
                    <div class="ads-form-steps__col  ads-form-steps__col--content  content-text  col">
                        <h3>Год выпуска</h3>
                        <select class="ads-form-steps__select  select">
                    ...
                    <div class="ads-form-steps__col  ads-form-steps__col--content  content-text  col">
                        <h3>Наработка</h3>
                        <select class="ads-form-steps__select  select">
                            <option data-display="Наработка в часах">1 часов</option>
                            <option>2 часов</option>
                            <option>3 часов</option>
                            <option>4 часов</option>
                        </select>
                    </div>
                    <div class="ads-form-steps__col  ads-form-steps__col--content  ads-form-steps__col--content--not--imported  content-text  col">
                        ...
                        <input type="text" placeholder="Где оно в данный момент" class="input ads-form-step__input">
            ...
            <div class="ads-form-steps__step  ads-form-steps__step--js" id="step3">
                ...
                <div class="ads-form-steps__main-list  row">
                    <div class="ads-form-steps__col  ads-form-steps__col--content  content-text  col-lg-3">
                        <h3>Цена</h3>
                        <!-- <select class="ads-form-steps__select  select">
                            <option data-display="Впишите сюда модель">модель 1</option>
                            <option>модель 2</option>
                            <option>модель 3</option>
                            <option>модель 4</option>
                        </select> -->
                        <input type="text" placeholder="Цена в рублях" class="input ads-form-step__input">
                    </div>
                    <div class="ads-form-steps__col  ads-form-steps__col--content  content-text  col-lg-3">
                        <h3>Гарантия</h3>
                        <!-- <select class="ads-form-steps__select  select">
                        ...
                        <input type="text" placeholder="Гарантия в месяцах" class="input ads-form-step__input">
                    </div>
                        ...
                        <div class="row">
                            <div class="ads-form-steps__col  ads-form-steps__col--content  content-text  col-lg-6">
                                ...
                                <div class="ads-form-step__text-file-wrap">
                                    <input type="text" placeholder="Название компании" class="input ads-form-step__input">
                            ...
                            <div class="ads-form-steps__col  ads-form-steps__col--content  content-text  col-lg-6">
                                <h3>ФИО</h3>
                                <input type="text" placeholder="" class="input ads-form-step__input">
                            </div>
                            <div class="ads-form-steps__col  ads-form-steps__col--content  content-text  col-lg-6">
                                <h3>Телефон</h3>
                                <input type="text" placeholder="" class="input ads-form-step__input">
