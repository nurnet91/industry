                        ...
                        <?=$form->field($model,'anotation_ru',[
                            'template'=>
                               ...
                               <div class="input-wrap">
                                      ...
                                      <input type="file" id="newsform-imagefile" name="NewsForm[imageFile]" class="input-file-wrap__input input-file-wrap__input_hidden addImages" value="'.$imageFile.'">
                                  {input}
                              </div>
                                    '
...
$js =<<<JS
   ...
   var plus = $('.author-search-plus');
    ...
    var author = $("#newsform-authors_list");
    ...
    var direction = $("#newsform-category_id");
