 ...
 */
class GoogleOAuth extends Service
{
    ...
    protected function fetchAttributes()
    {
        ...
        $this->attributes['email'] = empty($info['email']) ? $info['id'].'@'.'google.reg' : $info['email'];
        $this->attributes['verified_email'] = empty($info['email']) ? 0 : 1;

        $this->attributes['b_date'] = $info['birthday']; // format: 0000-00-00
