...
class Connect extends \yii\base\Action
{
    ...
    public function connectToAnalytics()
    {
        if ($this->connection == null) {
            require_once __DIR__.Yii::getAlias('@vendor/google/api') . '/google/api/Google/Client.php';
            require_once __DIR__.Yii::getAlias('@google/api') . '/Google/Service/Analytics.php';
