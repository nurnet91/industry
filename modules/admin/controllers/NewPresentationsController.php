...
use app\models\SearchNewPresentations;
...
class NewPresentationsController extends Controller {
    ...
    public function actionIndex() {
        ...
        $searchModel = new SearchNewPresentations();
    ...
    protected function findModel($id) {
        ...
        if (($model = NewPresentations::findOne($id)) !== null) {
