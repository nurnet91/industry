...
namespace app\modules\bizley\podium\src;
use app\modules\bizley\podium\src\log\DbTarget;
use app\modules\bizley\podium\src\maintenance\Maintenance;
use app\modules\bizley\podium\src\models\Activity;
use app\modules\bizley\podium\src\PodiumCache;
use app\modules\bizley\podium\src\PodiumConfig;
use Yii;
use yii\base\Action;
...
class Podium extends Module implements BootstrapInterface
{
    ...
    {
        parent::init();
        $this->setAliases(['@podium' => '@app/modules/bizley/podium/src']);
        if (Yii::$app instanceof WebApplication) {
            $this->podiumComponent->registerComponents();
            $this->layout = '@app/views/layouts/layout_index_forum';
        } else {
    ...
    public function bootstrap($app)
    {
        if ($app instanceof WebApplication) {
            ...
            $this->controllerNamespace = '@app\modules\bizley\podium\src\console';
        }
    }
    ...
    protected function setPodiumLogTarget($app)
    {
        ...
        $dbTarget->categories = ['@app\modules\bizley\podium\src\*'];
        $dbTarget->logVars = [];
