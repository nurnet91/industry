...
use app\modules\bizley\podium\src\models\ForumSearch;
use app\modules\bizley\podium\src\models\User;
use app\modules\bizley\podium\src\models\UserSearch;
...
class AdminController extends AdminForumController
{
    ...
    public function behaviors()
    {
        return [
            'access' => [
                ...
                'ruleConfig' => ['class' => 'app\modules\bizley\podium\src\filters\PermissionDeniedRule'],
                'rules' => [
    ...
    public function actions()
    {
        return [
            'promote' => [
                'class' => 'app\modules\bizley\podium\src\actions\AdminAction',
