    ...
    <div class="col-sm-12">
        <div class="panel panel-warning">
            <div class="panel-heading">
                <strong><?= t( 'Select posts to move') ?></strong>:
            </div>
        </div>
    </div>
</div><br>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <?= Html::label(t( 'Select a thread for this posts to be moved to'), 'newthread') ?>
                                <p>* <?= t( 'Forums you can moderate are marked with asterisk.') ?></p>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <?= Html::label(t( 'Name of the new thread'), 'newname') ?>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <?= Html::label(t( 'Parent forum of the new thread'), 'newforum') ?>
                                <p>* <?= t( 'Forums you can moderate are marked with asterisk.') ?></p>
                ...
                <div class="panel-footer">
                    <div class="row">
                        <div class="col-sm-12">
                            <?= Html::submitButton('<span class="glyphicon glyphicon-ok-sign"></span> ' . t( 'Move Posts'), ['class' => 'btn btn-block btn-primary', 'name' => 'save-button']) ?>
                        </div>
                    </div>
                </div>
            </div>
