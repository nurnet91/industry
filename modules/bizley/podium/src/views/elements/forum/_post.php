...
use app\modules\bizley\podium\src\assets\HighlightAsset;
...
<?php endif; ?>
                    &mdash;
                    <span class="podium-rating label label-<?= $ratingClass ?>" data-toggle="tooltip" data-placement="top" title="<?= t( 'Rating') ?>">
                        <?= $rating ?>
                    </span>
                ...
                <small>
                    <span class="label label-info" data-toggle="tooltip" data-placement="top" title="<?= t( 'Number of posts') ?>">
...
<?php endif; ?>
                    <li><a
                            ...
                            data-toggle="tooltip"
                            data-placement="top"
                            title="<?= t( 'Direct link to this post') ?>">
