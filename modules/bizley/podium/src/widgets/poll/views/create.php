...
<button class="btn btn-success podium-poll-add <?= $model->pollAdded ? 'hide' : '' ?>">
    <span class="glyphicon glyphicon-tasks"></span> <?= t( 'Add poll to this thread'); ?>
</button>

<div class="new-poll <?= $model->pollAdded ? '' : 'hide' ?>">
    <div class="panel panel-default">
        <div class="panel-heading">
            <button class="btn btn-xs btn-danger pull-right podium-poll-discard"><span class="glyphicon glyphicon-remove"></span> <?= t( 'Discard poll'); ?></button>
            <strong><?= t( 'New poll'); ?></strong>
        </div>
