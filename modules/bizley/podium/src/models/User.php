...
use app\modules\bizley\podium\src\models\db\UserActiveRecord;
...
class User extends UserActiveRecord
{
    ...
    public function rules()
    {
        $rules = [
            ...
            [['email', 'new_email'], 'email', 'message' => t( 'This is not a valid e-mail address.')],
            ['email', 'unique'],
            ...
            ['tos', 'compare', 'compareValue' => 1, 'message' => t( 'You have to read and agree on ToS.')],
        ];
    ...
    public static function getStatuses()
    {
        return [
            ...
            self::STATUS_REGISTERED => t( 'Registered'),
        ];
    }
