 ...
 */
class SearchFilterMainService extends FilterMain
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['direction_id', 'theme_id', 'theme_attr_id', 'theme_attr_parent_id',  'sub_theme_id', 'tech_id', 'operation_id', 'equipment_type_id', 'equipment_manufacturer_id', 'attributes_id', 'type', 'status', 'theme_attribute', 'show_anywhere'], 'integer'],
    ...
    {
        $query = FilterMain::find()->joinWith(['direction', 'theme', 'themeAttr', 'themeAttrParent', 'subTheme', 'technology', 'operation', 'eType', 'eManufacturer', 'operationAttribute'])->where(['type' => 1]);
